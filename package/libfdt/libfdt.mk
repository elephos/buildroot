...
define LIBFDT_BUILD_CMDS
	...
	$(TARGET_MAKE_ENV) $(TARGET_CC) $(TARGET_CFLAGS) \
		-I$(LINUX_DIR)/scripts/dtc -I$(LINUX_DIR)/scripts/dtc/libfdt \
			-L$(LINUX_DIR)/lib -o $(LINUX_DIR)/lib/fdtdump \
			$(LINUX_DIR)/scripts/dtc/util.c \
			$(LINUX_DIR)/scripts/dtc/fdtdump.c \
		-lfdt;
	$(TARGET_MAKE_ENV) $(TARGET_CC) $(TARGET_CFLAGS) \
		-I$(LINUX_DIR)/scripts/dtc -I$(LINUX_DIR)/scripts/dtc/libfdt \
			-L$(LINUX_DIR)/lib -o $(LINUX_DIR)/lib/fdtput \
			$(LINUX_DIR)/scripts/dtc/util.c \
			$(LINUX_DIR)/scripts/dtc/fdtput.c \
		-lfdt;
	$(TARGET_MAKE_ENV) $(TARGET_CC) $(TARGET_CFLAGS) \
		-I$(LINUX_DIR)/scripts/dtc -I$(LINUX_DIR)/scripts/dtc/libfdt \
			-L$(LINUX_DIR)/lib -o $(LINUX_DIR)/lib/fdtget \
			$(LINUX_DIR)/scripts/dtc/util.c \
